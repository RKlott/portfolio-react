...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "william.cesto14@gmail.com",
        href: "mailto:william.cesto14@gmail.com"
    },
    {
        icon: Phone,
        label: "Tél",
        value: "+33 7 49 07 07 93",
        href: "tel:+33749070793"
    },
    {
        icon: MapPin,
        label: "Location",
        value: "Langon, France",
        href: "https://www.google.com/maps/place/Langon"
    }
];
        ...
        <div className="container mx-auto px-6 relative z-10 ">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground animate-fade-in animation-delay/200">
              Vous avez un projet de création de site statique ou d'application web complète ? Discutons-en,
